      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form class="well form-search">
                 	<button id="insertBtn" type="button" class="btn btn-default btn-success dropdown-toggle" style="margin-top:10px;"> 
     				添加/修改
				    </button>
	...
	<script src="${APP_PATH}/jquery/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("tbody .btn-primary").click(function(){
             ...
             function querySchoolDesc(){
            	var loadingIndex = -1;
            	$.ajax({
            		type  : "POST",
            		url   : "${APP_PATH}/school/querySchoolDesc.do",
            		data  : {
            			id : "${loginUser.sch_id}"
            		},
            		beforeSend  : function(){
            		...
            		success : function(result){
            			if(result.success){
            			  var schoolDescData = result.data; 
            			  alert(schoolDescData.sch_name);
            			  $("#sch_name").val(schoolDescData.sch_name);
            			  $("#sch_img").val(schoolDescData.sch_img);
            			  $("#sch_number").val(schoolDescData.sch_number);
            			  $("#sch_type").val(schoolDescData.sch_type);
            			  $("#sch_motto").val(schoolDescData.sch_motto);
            			  $("#sch_address").val(schoolDescData.sch_address);
            			  $("#sch_desc").val(schoolDescData.sch_desc);
            			}
            		}
            	})
            } 
            ...
            $("#insertBtn").click(function(){
            	window.location.href = "${APP_PATH}/school/editDescSchool.htm"
            });
