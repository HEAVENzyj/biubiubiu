      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
              <div class="panel-heading">修改角色信息<div style="float:right;cursor:pointer;" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-question-sign"></i></div></div>
			  <div class="panel-body">
				<form id="RoleForm" role="form">
				  <div class="form-group">
					<label for="exampleInputPassword1">角色名称</label>
					<input type="text" class="form-control" id="role_name" value="${role.role_name}">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">角色描述</label>
					<input type="text" class="form-control" id="role_desc" value="${role.role_desc}">
				  </div>
	...
	<script src="${APP_PATH}/jquery/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("#updateBtn").click(function(){
            	$.ajax({
            		type : "POST",
            		url  : "${APP_PATH}/role/updateRole.do",
            		data : {
            		...
            		success : function(result){
            			if(result.success){
            				...
            				layer.msg("角色修改成功", {time:1000, icon:5, shift:6},function(){
